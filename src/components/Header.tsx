...
export function Header() {
  ...
  return (
    <>
      {/* Static header at top — no bg, overlays the hero */}
      ...
      {/* Sticky header — only visible on scroll-up, always has bg */}
      <header
        className={`fixed inset-x-0 top-0 z-50 bg-brand-purple shadow-md transition-transform duration-300 ${
